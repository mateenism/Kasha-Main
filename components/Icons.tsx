...
export const DesignIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-10 w-10 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
...
export const PuzzlePieceIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-10 w-10 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M14 10l-2 1m0 0l-2-1m2 1v2.5M20 7l-2 1m2-1l-2-1m2 1v2.5M14 4l-2 1m0 0l-2-1m2 1V7M4 7l2 1M4 7l2-1M4 7v2.5M12 21l-2-1m2 1l-2-1m2 1v-2.5M6 18l-2-1m2 1l-2-1m2 1V15M18 18l2-1m-2 1l2-1m-2 1V15" />
    </svg>
);
...
export const BriefcaseIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18.22V10.05a2.25 2.25 0 012.25-2.25H18M10.5 21V18H13.5V21M10.5 6H13.5V9H10.5V6Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 10.05a2.25 2.25 0 002.25-2.25V7.5a2.25 2.25 0 00-2.25-2.25H6A2.25 2.25 0 003.75 7.5v.3a2.25 2.25 0 002.25 2.25" />
    </svg>
);
...
export const QuoteIcon: React.FC<{className?: string}> = ({className}) => (
    <svg className={`w-16 h-16 ${className}`} fill="currentColor" viewBox="0 0 32 32">
        <path d="M9.3,21.3H2.9c-1.6,0-2.9-1.3-2.9-2.9V6.9C0,5.3,1.3,4,2.9,4h6.3c1.6,0,2.9,1.3,2.9,2.9v11.5C12.2,20,10.9,21.3,9.3,21.3z M29.1,21.3h-6.3c-1.6,0-2.9-1.3-2.9-2.9V6.9c0-1.6,1.3-2.9,2.9-2.9h6.3c1.6,0,2.9,1.3,2.9,2.9v11.5C32,20,30.7,21.3,29.1,21.3z"/>
    </svg>
);
...
export const GoldStarIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={`w-5 h-5 ${className}`}>
      <path fillRule="evenodd" d="M10.868 2.884c.321-.662 1.215-.662 1.536 0l1.681 3.462a1 1 0 00.951.69h3.462c.73 0 1.041.986.52 1.447l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.318.981-.784 1.783-1.528 1.243l-2.438-1.768a1 1 0 00-1.175 0l-2.438 1.768c-.744.54-1.846-.262-1.528-1.243l1.07-3.292a1 1 0 00-.364-1.118L2.24 8.483c-.52-.461-.21-1.447.52-1.447h3.462a1 1 0 00.951-.69l1.681-3.462z" clipRule="evenodd" />
    </svg>
);
...
export const UsersIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 00-9 0m9 0a9.094 9.094 0 01-9 0m9 0v.34c0 .587-.473 1.06-1.06 1.06H6.06C5.473 20.12 5 19.647 5 19.06v-.34m12 0a9.094 9.094 0 00-9 0" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75c-1.846 0-3.375-1.492-3.375-3.375S10.154 6 12 6s3.375 1.492 3.375 3.375S13.846 12.75 12 12.75z" />
    </svg>
);
